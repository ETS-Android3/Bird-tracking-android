...
public class Settings_Select_Options extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (myBird.FAB_Attributes_2_to_GPS_Perm == true) {
            ...
            rb_en.setEnabled(false);
            rb_de.setEnabled(false);
        }
        ...
        rb_en.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (rb_en.isChecked()) {
                    ...
                    myDb.deleteData_LanguageTable("de");
                    myDb.insertData_LanguageTable("en");
                    Toast.makeText(Settings_Select_Options.this,
                            myBird.language_chosen, Toast.LENGTH_SHORT).show();
                    refresh_flag_en = 11;
        ...
        rb_de.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (rb_de.isChecked()) {
                    myBird.language_chosen = "de";
                    myDb.deleteData_LanguageTable("en");
                    myDb.insertData_LanguageTable("de");
                    Toast.makeText(Settings_Select_Options.this,
                            myBird.language_chosen, Toast.LENGTH_SHORT).show();
                    refresh_flag_de = 11;
                    SetLanguage(myBird.language_chosen);
