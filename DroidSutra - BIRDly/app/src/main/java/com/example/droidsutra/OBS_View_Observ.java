...
public class OBS_View_Observ extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    static boolean message_flag = false;
        ...
        btnViewObs.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (res.getCount() == 0) {
                            showMessage(getResources().getString(R.string.obs), getResources().getString(R.string.found_not));
                            return;
                        }
    ...
    public void onBackPressed() {
        ...
        if (message_flag == true) {
            ...
            Intent intent = new Intent(OBS_View_Observ.this, HomeScreen.class);
